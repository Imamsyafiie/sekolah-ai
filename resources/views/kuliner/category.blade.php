      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="/">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Category <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
                    ...
                    <div class="blog-entry">
                        <a href="{{ route('kuliner.show', ['id' => $kuliner->id]) }}" class="block-20 d-flex align-items-end" style="background-image: url('{{ Storage::url($kuliner->image) }}');">
                            <div class="meta-date text-center p-2">
                                <span class="mos">{{ date('d F Y', strtotime($kuliner->publish_at)) }}</span>
                            </div>
                        </a>
                        <div class="text bg-white p-4">
                            ...
                            <div class="d-flex align-items-center mt-4">
                                ...
                                <p class="ml-auto mb-0">
                                    <a href="#" class="mr-2">{{ $kuliner->user->name }}</a>
                                </p>
                            </div>
                        </div>
                    </div>
