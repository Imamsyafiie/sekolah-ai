...
class KontenPembelajaranPolicy
{
    ...
    {
        return $user->can('view_any_konten::pembelajaran');
    }

    /**
     * Determine whether the user can view the model.
     */
    public function view(User $user, KontenPembelajaran $kontenPembelajaran): bool
    {
        return $user->can('view_konten::pembelajaran');
    }
    ...
    {
        return $user->can('create_konten::pembelajaran');
    }

    /**
     * Determine whether the user can update the model.
     */
    public function update(User $user, KontenPembelajaran $kontenPembelajaran): bool
    {
        return $user->can('update_konten::pembelajaran');
    }

    /**
     * Determine whether the user can delete the model.
     */
    public function delete(User $user, KontenPembelajaran $kontenPembelajaran): bool
    {
        return $user->can('delete_konten::pembelajaran');
    }
    ...
    {
        return $user->can('delete_any_konten::pembelajaran');
    }
